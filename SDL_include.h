...
#ifdef INCLUDE_SDL 
	#ifdef _WIN32
		#include <C:/SDL2-2.0.22/include/SDL2/SDL.h>
	#elif __APPLE__
...
*************************************************/
	...
	#ifdef _WIN32
		#include <C:/SDL2-2.0.22/include/SDL2/SDL_image.h>
	#elif __APPLE__
		#include "TargetConditionals.h"
...
*************************************************/
	...
	#ifdef _WIN32
		#include <C:/SDL2-2.0.22/include/SDL2/SDL_mixer.h>
	#elif __APPLE__
		#include "TargetConditionals.h"
...
*************************************************/
	...
	#ifdef _WIN32
		#include <C:/SDL2-2.0.22/include/SDL2/SDL_ttf.h>
	#elif __APPLE__
		#include "TargetConditionals.h"
...
*************************************************/
	...
	#ifdef _WIN32
		#include <C:/SDL2-2.0.22/include/SDL2/SDL_net.h>
	#elif __APPLE__
		#include "TargetConditionals.h"
